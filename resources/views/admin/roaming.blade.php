            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="card-box pb-2">
                        ...
                        <div dir="ltr">
                            <div id="deal-analytics" class="mt-4" data-colors="#7e57c2,#4fc6e1"></div>
                        </div>
                    </div> <!-- end card-box -->
                </div> <!-- end col-->
                ...
                <div class="col-xl-6">
                    <div class="card-box">
                        ...
                        <div dir="ltr">
                            <div id="sales-analytics" class="apex-charts" data-colors="#7e57c2,#1abc9c"></div>
                        </div>
                    </div> <!-- end card-box -->
                </div> <!-- end col-->
            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-sm table-nowrap table-centered mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <h5 class="font-14 my-1 font-weight-normal">Jeremy Young</h5>
                                        ...
                                        <tr>
                                            <td>
                                                <h5 class="font-14 my-1 font-weight-normal">Thomas Krueger</h5>
                                                <span class="text-muted mb-1 d-block font-13">Senior Sales Executive</span>
                                            </td>
                                            <td>235</td>
                                            <td>127</td>
                                        ...
                                        <tr>
                                            <td>
                                                <h5 class="font-14 my-1 font-weight-normal">Pete Burdine</h5>
                                                <span class="text-muted mb-1 d-block font-13">Senior Sales Executive</span>
                                            </td>
                                            <td>365</td>
                                            <td>148</td>
                                        ...
                                        <tr>
                                            <td>
                                                <h5 class="font-14 my-1 font-weight-normal">Mary Nelson</h5>
                                                <span class="text-muted mb-1 d-block font-13">Senior Sales Executive</span>
                                            </td>
                                            <td>753</td>
                                            <td>159</td>
                                        ...
                                        <tr>
                                            <td>
                                                <h5 class="font-14 my-1 font-weight-normal">Kevin Grove</h5>
                                                <span class="text-muted mb-1 d-block font-13">Senior Sales Executive</span>
                                            </td>
                                            <td>458</td>
                                            <td>126</td>
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="media">
                                <img class="mr-3 rounded-circle" src="../assets/images/users/user-2.jpg" width="40" alt="Generic placeholder image">
                            ...
                            <div class="media mt-3">
                                <img class="mr-3 rounded-circle" src="../assets/images/users/user-3.jpg" width="40" alt="Generic placeholder image">
                                <div class="media-body">
                            ...
                            <div class="media mt-3">
                                <img class="mr-3 rounded-circle" src="../assets/images/users/user-4.jpg" width="40" alt="Generic placeholder image">
                                <div class="media-body">
                            ...
                            <div class="media mt-3">
                                <img class="mr-3 rounded-circle" src="../assets/images/users/user-5.jpg" width="40" alt="Generic placeholder image">
                                <div class="media-body">
                                    <span class="badge badge-soft-warning float-right">Cold lead</span>
                            ...
                            <div class="media mt-3">
                                <img class="mr-3 rounded-circle" src="../assets/images/users/user-1.jpg" width="40" alt="Generic placeholder image">
                                <div class="media-body">
                                    <span class="badge badge-soft-warning float-right">Cold lead</span>
                            ...
                            <div class="media mt-3">
                                <img class="mr-3 rounded-circle" src="../assets/images/users/user-6.jpg" width="40" alt="Generic placeholder image">
                                <div class="media-body">
                                    <span class="badge badge-soft-success float-right">Won lead</span>
